...
@section('content')
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">Second Section</h3>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6 col-lg-6">
                ...
                <div class="box">
                    <!-- /.box-headerBlade -->
                    <form action="{{route('second.text.update')}}" method="post">
                        @csrf
                        <div class="box-body">
                            <input type="hidden" name="id" value="{{$second_section->id}}">
                        ...
                        <div class="box-footer ">
                            <div class="row">
                                <div class="col-md-9">
                                    <h5>Insert <strong>Second</strong> Section's Content in <strong>English</strong></h5>
                                </div>
                                <div class="col-md-3">
                ...
                <div class="box">
                    ...
                    <form action="{{route('second.text.update')}}" method="post">
                        ...
                        <div class="box-footer ">
                            <div class="row">
                                <div class="col-md-10">
                                    <h5>Insert <strong>Second</strong> Section's Content in <strong>Arabic</strong></h5>
                                </div>
                                <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-lg-6 col-6" >
                ...
                <div class="box" >
                    <div class="box-header with-border">
                        <h4 class="box-title"><strong>Second</strong> Section's Image</h4>
                    </div>
                    <div class="box-body">
                        <div id="carousel-example-generic-only-slide" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    @if(isset($second_section->file->file))
                                        <img src="{{asset($second_section->file->file)}}" class="img-fluid" height="50px"
                                             alt="slide-3">
                                    @else
                    ...
                    <div class="box-footer">
                        <form action="{{route('second.image.update')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <input type="hidden" value="{{$second_section->id}}" name="id">
                                <div class="col-md-10">
            ...
            <div class="col-lg-6 col-6">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title"><strong>Second</strong> Section's <strong>Edited</strong> Image</h4>
                    </div>
                    <div class="box-body">
                        <div id="carousel-example-generic-only-slide" class="carousel slide" data-ride="carousel">
                            <!-- Wrapper for slides -->
