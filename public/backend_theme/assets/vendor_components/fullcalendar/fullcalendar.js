...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    /* Options
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes a default column headerBlade formatting string if `colFormat` is not explicitly defined
    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        // if only one row of days, the classNames on the headerBlade can represent the specific days beneath
        if (t.rowCnt === 1) {
            classNames = classNames.concat(
            // includes the day-of-week class
            // noThemeHighlight=true (don't highlight the headerBlade)
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        ...
        var options;
        if (this.rowCnt === 1) {
            topEl = view.el; // will cause the popover to cover any sort of headerBlade
        }
        else {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<div class="fc-headerBlade ' + theme.getClass('popoverHeader') + '">' +
...
function makeDayGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        // Generates the HTML that will go before the day-of week headerBlade cells
...
StandardTheme.prototype.classes = {
    widget: 'fc-unthemed',
    widgetHeader: 'fc-widget-headerBlade',
    ...
    popoverHeader: 'fc-widget-headerBlade',
    popoverContent: 'fc-widget-content',
    // day grid
    headerRow: 'fc-widget-headerBlade',
...
JqueryUiTheme.prototype.classes = {
    widget: 'ui-widget',
    widgetHeader: 'ui-widget-headerBlade',
    ...
    popoverHeader: 'ui-widget-headerBlade',
    popoverContent: 'ui-widget-content',
    // day grid
    headerRow: 'ui-widget-headerBlade',
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.computeHeaderOptions = function () {
        return {
            extraClasses: 'fc-headerBlade-toolbar',
...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        if (!isAuto) {
            ...
            scrollbarWidths = this.scroller.getScrollbarWidths();
            if (scrollbarWidths.left || scrollbarWidths.right) {
                // make the all-day and headerBlade rows lines up
...
var OptionsManager = /** @class */ (function (_super) {
    ...
    OptionsManager.prototype.add = function (newOptionHash) {
        ...
        // catch-all. rerender the headerBlade and footer and rebuild/rerender the current view
...
Bootstrap4Theme.prototype.classes = {
    ...
    popoverHeader: 'card-headerBlade',
...
ViewRegistry_1.defineView('listDay', {
    ...
    duration: { days: 1 },
    defaults: {
        listDayFormat: 'dddd' // day-of-week is all we need. full date is probably in headerBlade
    }
});
