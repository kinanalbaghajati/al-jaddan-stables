...
var Lightbox = (function ($) {
    ...
    _$modal: The bootstrap modal generated
       ...
       _$modalHeader: The .modal-headerBlade
    ...
    _padding / _border: CSS properties for the modal container; these are used to calculate the available space for the content
   	 */
		...
		function Lightbox($element, config) {
			...
			var header = '<div class="modal-headerBlade' + (this._config.title || this._config.alwaysShowClose ? '' : ' hide') + '">' + (this._isBootstrap3 ? btn + h4 : h4 + btn) + '</div>';
			...
			this._$modalHeader = this._$modal.find('.modal-headerBlade').first();
