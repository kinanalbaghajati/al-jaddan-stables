...
**Recommended**
```
<!-- The page headerBlade should go into a headerBlade element -->
<headerBlade>
...
<main class="news-page" role="main">
  ...
  <section class="page-section news">
    <!-- A section headerBlade should go into a section element -->
    <headerBlade>
    ...
    <article class="news-article">
      <!-- An article can contain a headerBlade that contains the summary / introduction information of the article -->
      <headerBlade>
...
**Not recommended**
```
div.content > headerBlade.content-headerBlade > h2.title {
  font-size: 2em;
}
```
...
**Recommended**
```
.content > .content-headerBlade > .title {
  font-size: 2em;
}
```
